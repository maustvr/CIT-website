                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item"><a href="cartsAll.php">All Locations</a></li>
                            <li class="breadcrumb-item active"><a href="chartsCountry.php">Countries</a></li>
                     ...
                     <select class="nav-item dropdown" style="margin-left:1%;" id="selectState" placeholder="Please select state" name="state" value="" ><span class="caret"></span>
