                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="card mb-4">
                                    ...
                                    <?php
                                        $Query = "select Weapons, count(*) from Incidents JOIN departments on Incidents.deptId = departments.deptID 
                            ...
                            <div class="col-lg-6">
                                <div class="card mb-4">
                                    ...
                                    <?php
                                        ...
                                        $Query = "select MCInvolvement, count(*) from Incidents JOIN departments on Incidents.deptId = departments.deptID 
	                                            JOIN location on departments.locationID = location.locationID
                                                    where departments.locationID  IN
	                                                    (select locationID from location where country = '$country')
                            ...
                            <div class="col-lg-6">
                                <div class="card mb-4">
                                    ...
                                    <?php
                                        $Query = "select OfficerInvolv, count(*) from Incidents JOIN departments on Incidents.deptId = departments.deptID 
	                                            JOIN location on departments.locationID = location.locationID
                                                    where departments.locationID  IN
	                                                    (select locationID from location where country = '$country')
                            ...
                            <div class="col-lg-6">
                                <div class="card mb-4">
                                    ...
                                    <?php
                                        $Query = "select ConsThreatAsses, count(*) from Incidents JOIN departments on Incidents.deptId = departments.deptID 
	                                            JOIN location on departments.locationID = location.locationID
                                                    where departments.locationID  IN
	                                                    (select locationID from location where country = '$country')
                            ...
                            <div class="col-lg-6">
                                <div class="card mb-4">
                                    ...
                                    <?php
                                        $Query = "select CITOnScene, count(*) from Incidents JOIN departments on Incidents.deptId = departments.deptID 
	                                            JOIN location on departments.locationID = location.locationID
                                                    where departments.locationID  IN
	                                                    (select locationID from location where country = '$country')
                                                         group by CITOnScene;";
                            ...
                            <div class="col-lg-6">
                                <div class="card mb-4">
                                    ...
                                    <?php
                                        $Query = "select Outcome, count(*) from Incidents JOIN departments on Incidents.deptId = departments.deptID 
	                                            JOIN location on departments.locationID = location.locationID
                                                    where departments.locationID  IN
	                                                    (select locationID from location where country = '$country')
                                                         group by Outcome;";
